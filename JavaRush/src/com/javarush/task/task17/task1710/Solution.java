...
public class Solution {
    ...
    static SimpleDateFormat simpleDateFormat1 = new SimpleDateFormat("dd-MMM-yyyy", Locale.ENGLISH);
    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (args[0]) {
            ...
            case "-r":
                ...
                if (person != null) {
                    System.out.println(person.getName() + " " + (person.getSex() == Sex.MALE ? "м" : "ж") + " " + simpleDateFormat1.format(person.getBirthDate()));
                }
                break;
            case "-u":
